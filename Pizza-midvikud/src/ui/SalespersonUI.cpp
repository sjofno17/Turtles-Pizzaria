...
MenuPizzaModel SalespersonUI::menupizza_order()
{
    system("CLS");
...
ToppingsModel SalespersonUI::toppings_order()
{
    system("CLS");
        ...
        {
            cout << "Enter a number for topping to choose on pizza. (0 if you are finished)" << endl;
            cout << "-----------------------------------------------------------------------" << endl;
...
SizeCrustModels SalespersonUI::sizeCrust_order()
{
    system("CLS");
        ...
        {
            cout << "Enter a number for crust to choose on pizza. (0 if you are finished)" << endl;
            cout << "-----------------------------------------------------------------------" << endl;
            cout << "No:\tName:\tSize:\tprice:" << endl;
            cout << "-----------------------------------------------------------------------" << endl;
